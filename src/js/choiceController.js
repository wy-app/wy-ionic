...
angular.module('myApp.choiceController', [])
    .controller('choiceController', ['$scope', '$http', '$location', 'IPAndPort','$state','$timeout','myFactory',function ($scope,$http,$location,IPAndPort, $state,$timeout,myFactory) {
        ...
        function doRefresh(str) {
            ...
            if (str == 'down') {
                ...
                number = 20;
                var wyUrl = 'http://c.3g.163.com/nc/article/list/T1467284926140/0-'+ number +'.html';
                ...
                number += 20;
                wyUrl = 'http://c.3g.163.com/nc/article/list/T1467284926140/0-' + number +'.html';
                // console.warn(wyUrl)
            }

            wyUrl && myFactory.ajaxData(wyUrl,'精选');
        ...
        $scope.$on('success', function (e,msg) {
            if(msg[0] == '精选'){
                ...
                var result = msg[1];
                // console.info(result);
                result = result.data.T1467284926140;
