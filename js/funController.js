...
angular.module('myApp.funController', [])
    .controller('funController', ['$scope', '$http', '$location', '$timeout','IPAndPort','$state','myFactory', function ($scope,$http,$location,$timeout,IPAndPort,$state,myFactory) {
        ...
        function doRefresh(str) {
            ...
            if (str == 'down') {
                ...
                number = 20;
                var wyUrl = 'http://c.3g.163.com/nc/article/list/T1348648517839/0-'+ number +'.html';
                ...
                number += 20;
                wyUrl = 'http://c.3g.163.com/nc/article/list/T1348648517839/0-' + number +'.html';
                // console.warn(wyUrl)
            }

            wyUrl && myFactory.ajaxData(wyUrl,'娱乐');
        ...
        $scope.$on('success', function (e,msg) {
            if(msg[0] == '娱乐'){
                ...
                var result = msg[1];
                console.info(result);
                result = result.data.T1348648517839;
